...
The following arguments can be provided: `--path_dataset`, `--img_format`, `--dense_captioning`, `--ttext_sim`, `--ttext_yes`, `--dense_model`, `--dense_file`, and `--model_vqa_path`. Here is a brief description of each argument:
